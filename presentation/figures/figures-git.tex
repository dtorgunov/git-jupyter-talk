...
\tikzset{msg/.style={rectangle,draw,anchor=text,inner sep=2.5mm,node distance=1.0cm,rounded corners=0.25cm,fill=white}}
...
\begin{document}
  ...
  \begin{tikzpicture}[node distance=3.5cm,auto]
    ...
    \node[commit,right of=c1] (c2) {\quad};
    \node[commit,right of=c2] (c3) {\quad};
    \node[commit,right of=c3,draw=none,fill=none] (empt) {\quad};
